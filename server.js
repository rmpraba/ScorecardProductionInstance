...
app.post('/Lessonplan-concepts',  urlencodedParser,function (req, res)
{
    ...
    console.log(qur);
    connection.query("SELECT  * FROM md_curriculum_display WHERE school_id='"+req.body.schoolid+"' and academic_year='"+req.body.academicyear+"' and grade_name in('"+req.body.grade+"') and subject_name in('"+req.body.subject+"') and chapter_id in('"+req.body.chapterid+"')",
    function(err, rows)
    {
    if(!err)
    {
...
app.post('/Lessonplan-currdate-concepts',  urlencodedParser,function (req, res)
{
    var qur="SELECT  * FROM md_curriculum_display WHERE school_id='"+req.body.schoolid+"' and academic_year='"+req.body.academicyear+"' and grade_name in('"+req.body.grade+"') and subject_name in('"+req.body.subject+"') and chapter_id in('"+req.body.chapterid+"') "+
...
app.post('/lessonplan-assesment-students',  urlencodedParser,function (req, res)
{
    var qur="SELECT  * FROM md_student WHERE school_id='"+req.body.schoolid+"' AND academic_year='"+req.body.academicyear+"' "+
    " AND flag='active' AND class_id=(SELECT id FROM md_class_section WHERE school_id='"+req.body.schoolid+"' AND academic_year='"+req.body.academicyear+"' AND class='"+req.body.grade+"' AND section='"+req.body.section+"')";
    console.log(qur);
    connection.query(qur,
    function(err, rows)
    {
...
app.post('/lessonplan-saveassesmentmark',  urlencodedParser,function (req, res)
{
  var response={ 
      school_id: req.body.schoolid,
      ...
      assesment_date: req.body.assesmentdate,
    ...
    var checkqur="SELECT * FROM md_concept_assesment WHERE school_id='"+req.body.schoolid+"' and academic_year='"+req.body.academicyear+"' and "+
    " grade_id='"+req.body.gradeid+"' and subject_id='"+req.body.subjectid+"' and term_id='"+req.body.termid+"' and chapter_id='"+req.body.chapterid+"' and concept_id='"+req.body.conceptid+"' and row_id='"+req.body.rowid+"' "+
    " and section_id='"+req.body.sectionid+"' and sno='"+req.body.rowsno+"' and sub_concept_id='"+req.body.subconceptid+"' and student_id='"+req.body.studentid+"'";
    var updatequr="UPDATE md_concept_assesment SET mark='"+req.body.mark+"' WHERE school_id='"+req.body.schoolid+"' and academic_year='"+req.body.academicyear+"' and "+
    " grade_id='"+req.body.gradeid+"' and subject_id='"+req.body.subjectid+"' and term_id='"+req.body.termid+"' and chapter_id='"+req.body.chapterid+"' and concept_id='"+req.body.conceptid+"' and row_id='"+req.body.rowid+"' "+
    " and section_id='"+req.body.sectionid+"' and sno='"+req.body.rowsno+"' and sub_concept_id='"+req.body.subconceptid+"' and student_id='"+req.body.studentid+"'";
    ...
    {
     console.log(err);
     res.status(200).json({'returnval': 'Not Updated'+err}); 
    }
    });
    }
    else{
...
app.post('/lessonplan-updatecompletionstatus',  urlencodedParser,function (req, res)
{
  var response={ 
      school_id: req.body.schoolid,
      academic_year: '2017-2018',      
      ...
      sno: req.body.rowsno,
      sub_teacher_remark:"",  
      assesment_status: "Completed",    
      assesment_date: req.body.assesmentdate,     
      complete_date: req.body.currdate,
      status: "Completed"
    };


    var studcheck1="SELECT count(student_id) as count FROM md_concept_assesment WHERE school_id='"+req.body.schoolid+"' and academic_year='"+req.body.academicyear+"' and "+
    " grade_id='"+req.body.gradeid+"' and subject_id='"+req.body.subjectid+"' and term_id='"+req.body.termid+"' and chapter_id='"+req.body.chapterid+"' and concept_id='"+req.body.conceptid+"' and row_id='"+req.body.rowid+"' "+
    " and section_id='"+req.body.sectionid+"' and sno='"+req.body.rowsno+"' and sub_concept_id='"+req.body.subconceptid+"'";

    var studcheck2="SELECT count(id) as count FROM md_student WHERE school_id='"+req.body.schoolid+"' and academic_year='"+req.body.academicyear+"' and class_id in "+
    " (SELECT id FROM md_class_section WHERE class='"+req.body.gradename+"' AND section='"+req.body.sectionname+"') and flag='active'";

    var updatestatusqur="UPDATE md_curriculum_planning_approval SET complete_date='"+req.body.currdate+"',assesment_status='Pending',status='Pending' WHERE school_id='"+req.body.schoolid+"' and academic_year='"+req.body.academicyear+"' and "+
    " grade_id='"+req.body.gradeid+"' and subject_id='"+req.body.subjectid+"' and term_id='"+req.body.termid+"' and chapter_id='"+req.body.chapterid+"' and concept_id='"+req.body.conceptid+"' and row_id='"+req.body.rowid+"' "+
    " and section_id='"+req.body.sectionid+"' and sno='"+req.body.rowsno+"' and sub_concept_id='"+req.body.subconceptid+"' and emp_id='"+req.body.empid+"'";


    var checkqur="SELECT * FROM md_curriculum_planning_approval WHERE school_id='"+req.body.schoolid+"' and academic_year='"+req.body.academicyear+"' and "+
    " grade_id='"+req.body.gradeid+"' and subject_id='"+req.body.subjectid+"' and term_id='"+req.body.termid+"' and chapter_id='"+req.body.chapterid+"' and concept_id='"+req.body.conceptid+"' and row_id='"+req.body.rowid+"' "+
    " and section_id='"+req.body.sectionid+"' and sno='"+req.body.rowsno+"' and sub_concept_id='"+req.body.subconceptid+"' and emp_id='"+req.body.empid+"'";
    var updatequr="UPDATE md_curriculum_planning_approval SET complete_date='"+req.body.currdate+"',assesment_status='Completed',status='Completed' WHERE school_id='"+req.body.schoolid+"' and academic_year='"+req.body.academicyear+"' and "+
    " grade_id='"+req.body.gradeid+"' and subject_id='"+req.body.subjectid+"' and term_id='"+req.body.termid+"' and chapter_id='"+req.body.chapterid+"' and concept_id='"+req.body.conceptid+"' and row_id='"+req.body.rowid+"' "+
    " and section_id='"+req.body.sectionid+"' and sno='"+req.body.rowsno+"' and sub_concept_id='"+req.body.subconceptid+"' and emp_id='"+req.body.empid+"'";
    var insertqur="INSERT INTO md_curriculum_planning_approval SET ?";

    var length1=0,length2=0;
    connection.query(studcheck1,function(err, rows){
    if(!err)
    {
      length1=rows[0].count;
    connection.query(studcheck2,function(err, rows){
    if(!err)
    {
      length2=rows[0].count;
      console.log("Printing length-----"+length1+"  "+length2);
      if(length1==length2){
        console.log('---equal length----');
          ...
          if(rows.length>0){
              ...
              if(!err)
              {
                ...
                console.log('----check and not update-----');
                res.status(200).json({'returnval': 'Not Updated'});
              }
              });
          }
          else{
              connection.query(insertqur,[response],function(err, rows){
              if(!err)
              {
                ...
                console.log('----check and not insert-----');
                res.status(200).json({'returnval': 'Not Updated'});
              }
              });
          }
            ...
            console.log('----not checking availability-----');
          }
          });
        ...
        connection.query(checkqur,function(err, rows){
          ...
          { 
          console.log('----checking availability-----');
          response.assesment_status="Pending";
          response.status="Pending";
          if(rows.length>0){
              connection.query(updatestatusqur,function(err, rows){
              if(!err)
              {
                console.log('----check and update-----');
                res.status(200).json({'returnval': 'Updated'});
        ...
        // }
        // else{
        //   console.log('----not updating only status-----');
        //   res.status(200).json({'returnval': 'Not Updated'});
        // }
        // });
      }
...
app.post('/lessonplan-saveremark',  urlencodedParser,function (req, res)
{
  var response={ 
      school_id: req.body.schoolid,
      academic_year: '2017-2018',      
      ...
      section_name: req.body.sectionname,
      term_id:req.body.termid,
      enrichment_sug:req.body.suggestion,
      sno: req.body.rowsno,
      sub_teacher_remark:req.body.teacherremark,  
      assesment_status: "",    
      assesment_date: req.body.assesmentdate,     
      complete_date: req.body.currdate
    };
    ...
    " grade_id='"+req.body.gradeid+"' and subject_id='"+req.body.subjectid+"' and term_id='"+req.body.termid+"' and chapter_id='"+req.body.chapterid+"' and concept_id='"+req.body.conceptid+"' and row_id='"+req.body.rowid+"' "+
    " and section_id='"+req.body.sectionid+"' and sno='"+req.body.rowsno+"' and sub_concept_id='"+req.body.subconceptid+"' and emp_id='"+req.body.empid+"'";
    var updatequr="UPDATE md_curriculum_planning_approval SET enrichment_sug='"+req.body.suggestion+"',sub_teacher_remark='"+req.body.teacherremark+"' WHERE school_id='"+req.body.schoolid+"' and academic_year='"+req.body.academicyear+"' and "+
    " grade_id='"+req.body.gradeid+"' and subject_id='"+req.body.subjectid+"' and term_id='"+req.body.termid+"' and chapter_id='"+req.body.chapterid+"' and concept_id='"+req.body.conceptid+"' and row_id='"+req.body.rowid+"' "+
    " and section_id='"+req.body.sectionid+"' and sno='"+req.body.rowsno+"' and sub_concept_id='"+req.body.subconceptid+"' and emp_id='"+req.body.empid+"'";
...
{  
  var que="SELECT distinct(p.grade_id),p.grade_name,p.subject_id,p.subject_name,g.section_id FROM mp_teacher_grade g JOIN md_curriculum_display p ON "+
              ...
              for(var i=0;i<mapping.length;i++){
                ...
                for(var j=0;j<approved.length;j++){
                  if(mapping[i].grade_id==approved[j].grade_id&&mapping[i].section_id==approved[j].section_id&&
                    ...
                    mapping[i].sub_concept_id==approved[j].sub_concept_id&&approved[j].status=="Completed"){
                    flag=1;
                    mapping.splice(i,1);
                    i--;
                    break;
...
app.post('/sendhomework',  urlencodedParser,function (req, res){
    var response={
      school_id: req.body.schoolid,
      academic_year: '2017-2018',      
      grade_id: req.body.gradeid,
      grade_name: req.body.grade,   
      subject_id: req.body.subjectid,
      ...
      row_id: req.body.rowid,
      concept_id: req.body.conceptid,
      concept_name: req.body.concept,
      sub_concept_id: req.body.subconceptid,
      sub_concept_name: req.body.subconcept,
      ...
      emp_name:req.body.empname,
      sno: req.body.rowsno,   
      homework_date: req.body.currdate,
      homework_subject: req.body.homesubject,
      homework_body: req.body.homecontent,
      homework_url: req.body.homeaid
    };
    var response1={  
      homework_date: req.body.currdate,
      homework_subject: req.body.homesubject,
    ...
    var qur="SELECT * FROM md_register WHERE id in (SELECT id FROM md_student WHERE class_id in(SELECT id FROM md_class_section WHERE class='"+req.body.grade+"' AND section='"+req.body.section+"'))";
    var checkqur="SELECT * FROM md_daily_homework WHERE school_id='"+req.body.schoolid+"' and academic_year='"+req.body.academicyear+"' and "+
    " grade_id='"+req.body.gradeid+"' and subject_id='"+req.body.subjectid+"' and term_id='"+req.body.term+"' and chapter_id='"+req.body.chapterid+"' and concept_id='"+req.body.conceptid+"' and row_id='"+req.body.rowid+"' "+
    " and section_id='"+req.body.sectionid+"' and sno='"+req.body.rowsno+"' and sub_concept_id='"+req.body.subconceptid+"' and emp_id='"+req.body.empid+"'";
    var updatequr="UPDATE md_daily_homework SET ? WHERE school_id='"+req.body.schoolid+"' and academic_year='"+req.body.academicyear+"' and "+
    " grade_id='"+req.body.gradeid+"' and subject_id='"+req.body.subjectid+"' and term_id='"+req.body.term+"' and chapter_id='"+req.body.chapterid+"' and concept_id='"+req.body.conceptid+"' and row_id='"+req.body.rowid+"' "+
    " and section_id='"+req.body.sectionid+"' and sno='"+req.body.rowsno+"' and sub_concept_id='"+req.body.subconceptid+"' and emp_id='"+req.body.empid+"'";
    var insertqur="INSERT INTO md_daily_homework SET ?";
    console.log(qur);    
    var id=[];
    connection.query(checkqur, function(err, rows)
    {
  ...
  {
    connection.query(updatequr,[response1], function(err, rows)
    {
    if(!err){
    connection.query(qur, function(err, rows)
    {
...
app.post('/lessonplan-homework',  urlencodedParser,function (req, res)
{

    var qur = "SELECT * FROM md_class_section WHERE school_id='"+req.body.schoolid+"' and academic_year='2017-2018' and "+
    " id in (SELECT class_id FROM md_student WHERE school_id='"+req.body.schoolid+"' and academic_year='2017-2018' and id='"+req.body.empid+"') ";
    console.log(qur);
    connection.query(qur, function(err, rows)
    {
    if(!err){
    var que = "SELECT * FROM md_daily_homework WHERE school_id='"+req.body.schoolid+"' and academic_year='2017-2018' "+
    "and  grade_name='"+rows[0].class+"' and  section_name='"+rows[0].section+"'"; 
    console.log(que); 
    connection.query(que, function(err, rows)
    {
          if(!err){
...
{
    var que = "SELECT * FROM mp_teacher_grade g join md_curriculum_display p on(g.grade_id=p.grade_id) WHERE "+
    " g.school_id='"+req.body.schoolid+"' and g.id='"+req.body.empid+"' and g.academic_year='2017-2018' and g.flage='active' and "+
...
{
    var que = "select distinct(id),emp_mobile from md_curriculum_display p join mp_teacher_grade g on(p.grade_id=g.grade_id) join md_employee_creation c on(g.id=c.emp_id) where  p.school_id='"+req.body.schoolid+"' and p.academic_year='2017-2018' and g.school_id='"+req.body.schoolid+"' and g.academic_year='2017-2018' and c.school_id='"+req.body.schoolid+"' and c.academic_year='2017-2018' and "+
...
{
  var que = "select distinct(chapter_id),chapter_name from md_curriculum_display where school_id='"+req.body.schoolid+"' and "+
...
{
  var que = "select distinct(concept_id),concept_name from md_curriculum_display where school_id='"+req.body.schoolid+"' and "+
  " academic_year='2017-2018' and grade_name='"+req.body.grade+"' and subject_name='"+req.body.subject+"' and term_id='"+req.body.term+"' and "+
  " ((STR_TO_DATE( planned_date_from,  '%m/%d/%Y' ) <= STR_TO_DATE(  '"+req.body.currdate+"',  '%d/%m/%Y' )) "+
  " OR (STR_TO_DATE( planned_to_date,  '%m/%d/%Y' ) >= STR_TO_DATE(  '"+req.body.currdate+"',  '%d/%m/%Y' ))) "+
...
app.post('/scorecardreadyness-service',  urlencodedParser,function (req,res)
{
  ...
  console.log(qur1);
  console.log("_____________________2");
  console.log(qur2);
  console.log("_____________________3");
  console.log(qur3);
  console.log("_____________________4");
  console.log(qur4);
  console.log("_____________________5");
  console.log(qur5);
  console.log("_____________________6");
  console.log(qur6);
  console.log("_____________________7");
  console.log(qur7);
...
app.post('/fnsendconcept1-service' , urlencodedParser,function (req, res)
{  
  var response={ 
       concept_id:req.query.concept_id,
       concept:req.query.concept,
...
connection.query("SELECT * FROM md_concept WHERE concept='"+req.query.concept+"'and capter_id='"+req.query.capter_id+"'",function(err, rows)
    {
    if(rows.length==0)
    {
      connection.query("INSERT INTO md_concept SET ? ",[response],
...
app.post('/lessonplanvalue-service',  urlencodedParser,function (req,res)
  {     
...
app.post('/conceptassement-service' ,urlencodedParser, function (req, res)
    {  
...
app.post('/fngetconceptreport-service' ,urlencodedParser, function (req, res)
   ...
   var qur1="select * from md_curriculum_display where school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academic_year+"'and subject_id='"+req.query.subjectid+"' and grade_id='"+req.query.gradeid+"'and term_id='"+req.query.termid+"' ";
       ...
       console.log('----------------------------------------');
          ...
          displayarr="empty";
          res.status(200).json({'curriculamarr':curriculamarr,'displayarr':displayarr});
          }
         console.log(err);
         });
         }
...
app.post('/fngetconceptreport-service',  urlencodedParser,function (req, res)
{
 ...
 var qur="select f.capter_id ,f.section_id,gs.section_id as section_name,ch.capter,e.emp_name,f.emp_id ,f.concept_id,cp.concept,f.skill,f.innovation,f.value,f.remark,f.enrichment_sug,f.planning_date,f.completion_date   from  final_book_sug f  join md_grade g on(g.grade_id=f.grade_id) join md_subject s on(s.subject_id=f.subject_id) join mp_grade_section gs on(gs.class_id=f.section_id) join md_chapter ch on(ch.capter_id=f.capter_id) join   md_employee_creation e on(e.emp_id=f.emp_id)  join  md_concept  cp  on(cp.concept_id=f.concept_id)  where f.school_id='"+req.query.schoolid+"' and f.completion='No' and gs.school_id='"+req.query.schoolid+"' and gs.grade_id=f.grade_id and gs.academic_year='"+req.query.academic_year+"'  and f.academic_year='"+req.query.academic_year+"' and ch.school_id='"+req.query.schoolid+"' and  f.subject_id='"+req.query.subjectid+"' and f.grade_id='"+req.query.gradeid+"'";
  ...
  console.log('-------------------Incomplete Chapter Report----------------------');
  console.log(qur);
  console.log(qur1);
     connection.query(qur, function(err, rows){
    if(!err)
...
{
  var qur=  "select *,chapter_id as chapterid,row_id as rowid, (select homecurrurl from md_curriculum_display where chapter_id=chapterid and row_id=rowid and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academic_year+"' and grade_id='"+req.query.gradeid+"' and subject_id='"+req.query.subjectid+"' ) as homelink , (select current_url from md_curriculum_display where chapter_id=chapterid and row_id=rowid and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academic_year+"' and grade_id='"+req.query.gradeid+"' and subject_id='"+req.query.subjectid+"' ) as teachlink,(select homework_type from md_curriculum_display where chapter_id=chapterid and row_id=rowid and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academic_year+"' and grade_id='"+req.query.gradeid+"' and subject_id='"+req.query.subjectid+"' ) as homefile ,(select teaching_aid from md_curriculum_display where chapter_id=chapterid and row_id=rowid and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academic_year+"' and grade_id='"+req.query.gradeid+"' and subject_id='"+req.query.subjectid+"' ) as teachfile from md_curriculum_planning_approval  where school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academic_year+"'and grade_id='"+req.query.gradeid+"' and subject_id='"+req.query.subjectid+"'and planned_date_from between '"+req.query.fromdate+"' and '"+req.query.todate+"'  " 
...
app.post('/fngetcurriculam-service',  urlencodedParser,function (req, res)
{
  ...
  var qur="select * from md_curriculum_display where school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and grade_id='"+req.query.gradeid+"' and subject_id='"+req.query.subjectid+"' and  planned_date_from between '"+req.query.fromdate+"' and '"+req.query.todate+"'";
...
{  
  var qur="SELECT * FROM master_assesment where school_board='"+req.query.board+"' and school_id='"+req.query.school_id+"' and academic_year='"+req.query.academic_year+"' ";
  console.log(qur);
   connection.query(qur,
    function(err, rows)
    {
...
{  
  var response={
       ...
       console.log(response);
          var qur="SELECT * FROM master_assesment WHERE school_id='"+req.query.school_id+"' and academic_year='"+req.query.academic_year+"' and assesment_name='"+req.query.assesment+"'";
   connection.query(qur,function(err, rows)
    {
     if(rows.length==0){
   connection.query("INSERT INTO master_assesment SET ?",[response],
     function(err, rows)
     {
     if(!err)
     {
...
{  
     var qur1="update master_assesment set assesment_name='"+req.query.assesment+"' where school_id='"+req.query.school_id+"' and academic_year='"+req.query.academic_year+"' and assesment_id='"+req.query.assesmentid+"' and school_board='"+req.query.board+"'";
     
     var qur="select * from master_assesment where assesment_name='"+req.query.assesment+"' and school_id='"+req.query.school_id+"' and academic_year='"+req.query.academic_year+"' and  school_board='"+req.query.board+"'";
console.log(qur);
 connection.query(qur,function(err, rows){  
        if(!err)
        {
...
{  
      var qur1="delete from master_assesment where assesment_name='"+req.query.assesmenvalue+"' and  school_id='"+req.query.school_id+"' and academic_year='"+req.query.academic_year+"' and assesment_id='"+req.query.assesmenid+"' and school_board='"+req.query.board+"'";
    console.log(qur1);
    connection.query(qur1,function(err, result){  
          console.log('update');
        if(!err)
...
{  
     ...
     var qur1="select * from master_assesment  where school_id='"+req.query.school_id+"' and academic_year='"+req.query.academic_year+"' and school_board='"+req.query.board+"'";
...
app.post('/homework-service' ,urlencodedParser, function (req, res)
    {  
     var qur1="SELECT * FROM md_concept_homework  where concept_id='"+req.query.conceptid+"'";
   ...
   console.log('-------------------------------');
        ...
        if(!err){
           ...
           res.status(200).json({'returnval': rows,'homeworkarr':homeworkarr,'dbarr':dbarr});
...
app.post('/curriculmsendmail1-service' , urlencodedParser,function (req, res)
   { 
    var response={ 
       ...
       sub_concept_name:req.query.subconceptname, 
       row_id: req.query.rowid,
       homework_subject:req.query.subjectcontent,
       homework_body:req.query.homecontent,
        sno:req.query.sno,
       emp_id:req.query.empid,
       emp_name:req.query.empname,
       sno:req.query.sno,
       homework_url:req.query.link,
       homework_date:req.query.homeworkdate,
   };
 
     var qur='select  * from   md_daily_homework  where school_id="'+req.query.schoolid+'" and academic_year="'+req.query.academicyear+'" and grade_id="'+req.query.gradeid+'" and subject_id="'+req.query.subjectid+'"  and chapter_id="'+req.query.chapterid+'"and row_id="'+req.query.rowid+'" and term_id="'+req.query.termid+'"   and section_id="'+req.query.sectionid+'" and emp_id="'+req.query.empid+'"';

     var qur1='update  md_daily_homework set link="'+req.query.link+'",home_content="'+req.query.homecontent+'",subject_content="'+req.query.subjectcontent+'", where school_id="'+req.query.schoolid+'" and academic_year="'+req.query.academicyear+'" and grade_id="'+req.query.gradeid+'" and subject_id="'+req.query.subjectid+'" and chapter_id="'+req.query.chapterid+'" and row_id="'+req.query.rowid+'"  and term_id="'+req.query.termid+'" and section_id="'+req.query.sectionid+'" and emp_id="'+req.query.empid+'"';
   ...
   connection.query(qur,
    ...
    console.log(rows.length);
     ...
     if(rows.length==0){
     connection.query("INSERT INTO md_daily_homework SET ?",[response],
    function(err, rows)
    {
    if(!err)
    {
...
console.log("-------teaching Aids---------");
console.log(response);
console.log("-----------------------------");

  connection.query("INSERT INTO md_concept_teaching set ?",[response],
    function(err, rows)
    {
    if(!err)
    {    
...
app.post('/passcurriculumhomework-service',  urlencodedParser,function (req, res)
{  
  var response={
         row_id:req.query.rowid,
         sno:req.query.sno,
...
console.log("--------------------------");
  ...
  connection.query("INSERT INTO md_concept_finalhomework set ?",[response],
    function(err, rows)
    {
    if(!err)
    {    
...
app.post('/passcurriculumlessonplan-service' , urlencodedParser,function (req, res)
   { 
    var response={
         ...
         co_ordinator_remarks:req.query.coremarks, 
         row_id:req.query.rowid,
         sno:req.query.sno,
         emp_name:req.query.empname,
         subject_id:req.query.subjectid,
...
app.post('/curriculampassassesmentvalue-service' , urlencodedParser,function (req, res)
  ...
  var qur='select  * from   md_concept_assesment  where school_id="'+req.query.schoolid+'" and academic_year="'+req.query.academicyear+'" and grade_id="'+req.query.gradeid+'" and subject_id="'+req.query.subjectid+'" and section_id="'+req.query.sectionid+'" and emp_id="'+req.query.empid+'" and chapter_id="'+req.query.chapterid+'" and concept_id="'+req.query.conceptid+'"  and row_id="'+req.query.rowid+'" and  student_id="'+req.query.StudentId+'"';

  var qur1='update  md_concept_assesment set mark="'+req.query.Mark+'"where school_id="'+req.query.schoolid+'"and academic_year="'+req.query.academicyear+'" and grade_id="'+req.query.gradeid+'" and subject_id="'+req.query.subjectid+'" and section_id="'+req.query.sectionid+'" and emp_id="'+req.query.empid+'" and chapter_id="'+req.query.chapterid+'" and concept_id="'+req.query.conceptid+'"  and row_id="'+req.query.rowid+'" and student_id="'+req.query.StudentId+'"';
...
app.post('/curriculmsendmail-servicee', urlencodedParser,function (req, res){
 ...
 var mailsubject,mailcontent,maillink;
 var listofemails = ["rmpraba@gmail.com","rmpraba.sessssscxxxx@gmail.com","samsidhmlzs@gmail.com","samsidhschools@gmail.com"]; 
...
app.post('/curriculmsendmail-service', urlencodedParser,function (req, res){
  ...
  maillink=req.query.link;  
  var qur = "SELECT email FROM parent WHERE student_id in(SELECT id FROM md_student WHERE school_id='"+req.query.schoolid+"' AND academic_year='"+req.query.academicyear+"' AND class_id='"+req.query.sectionid+"')";
  console.log(qur);
  connection.query("SELECT email FROM parent WHERE student_id in(SELECT id FROM md_student WHERE school_id='"+req.query.schoolid+"' AND academic_year='"+req.query.academicyear+"' AND class_id='"+req.query.sectionid+"') ",
    function(err, rows)
    {
    if(!err)
    {
...
function massMailer() {
 ...
 massMailer.prototype.SendEmail = function(Email,callback) {
  ...
  var mailbody="<html><body><h4>Hello Parent</h4><h4>Greeting from Samsidh Zee School!!</h4>"
  mailbody+="<div style='border-style: solid;border-width: thin;width:70%;'><div style='background-color:orange;border-style: solid;border-width: thin;'>"
  mailbody+="<table style='width:100%;'><tr><td><img src='https://s3.ap-south-1.amazonaws.com/samsidhreportcard/image/zeesouth.png' height='50px' width='50px'></td><td>"
  mailbody+="<h3>Today's Homework</h3></td></tr></table></div>"
  mailbody+="<div style='padding:5%;'><h4>Content: </h4><p style='color:red'>"+mailcontent+"</p>"
  mailbody+="<h4>Reference: </h4><p style='color:blue'>"+maillink+"</p></div></div></body></html>";
     var self = this;
     self.status = false;
     async.waterfall([
         function(callback) {                
